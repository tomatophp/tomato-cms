<x-tomato-admin-layout>
    ...
    <x-slot:buttons>
        <x-tomato-admin-button :modal="true" :href="route('admin.pages.create')" type="link">
    ...
    <x-tomato-admin-row table type="bool" :value="$item->has_view" />
                ...
                <x-splade-cell actions>
                    <div class="flex justify-start">
                        ...
                        <x-tomato-admin-button warning type="icon" title="{{trans('tomato-admin::global.crud.edit')}}" modal :href="route('admin.pages.edit', $item->id)">
