<x-tomato-admin-layout>
    <x-slot name="header">
        {{trans('tomato-admin::global.crud.create')}} {{__('Content')}}
    </x-slot>

    <x-splade-form class="grid grid-cols-12 gap-4 my-4" action="{{route('admin.contents.store')}}" method="post">
        ...
        <div class="col-span-4 space-y-4">
            <div class="border border-gray-300 rounded-lg bg-white">
                ...
                <div class="flex justify-end py-2 px-4">
                    <x-splade-submit>Publish</x-splade-submit>
                </div>
            </div>
            <div class="border border-gray-300 rounded-lg bg-white">
                <div class="py-2 px-4">
            ...
            <div class="border border-gray-300 rounded-lg bg-white">
                ...
                <hr>
                <div class="py-2 px-4">
                    <x-splade-form class="flex justify-start w-full my-2">
                        <x-splade-input  name="name" placeholder="Tag Name"  />
                        <x-splade-submit class="ml-2" label="Add" />
                    </x-splade-form>
