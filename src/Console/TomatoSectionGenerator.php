...
class TomatoSectionGenerator extends Command
{
    use RunCommand;
     ...
     * @var string
     */
    protected $signature = 'tomato-section:generate
        {section=0}
        {module=0}
        {view=0}
    ';
    ...
    public function handle()
    {
        ...
        $generator = new \TomatoPHP\TomatoCms\Services\TomatoSectionGenerator(
            section: $sectionName,
