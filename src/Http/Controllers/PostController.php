...
class PostController extends Controller
{
    ...
    {
        $this->model = \TomatoPHP\TomatoCms\Models\Post::class;
    }
    ...
    public function index(Request $request): View|JsonResponse
    {
        return Tomato::index(
            ...
            table: \TomatoPHP\TomatoCms\Tables\PostTable::class
        );
    }
    ...
    public function api(Request $request): JsonResponse
    {
        return Tomato::json(
            request: $request,
            model: \TomatoPHP\TomatoCms\Models\Post::class,
        );
    }
    ...
    /**
     * @param \TomatoPHP\TomatoCms\Models\Post $model
     * @return View|JsonResponse
     */
    public function show(\TomatoPHP\TomatoCms\Models\Post $model): View|JsonResponse
    {
        return Tomato::get(
            model: $model,
     ...
     * @return View
     */
    public function edit(\TomatoPHP\TomatoCms\Models\Post $model): View
    {
        return Tomato::get(
            model: $model,
     ...
     * @return RedirectResponse|JsonResponse
     */
    public function update(Request $request, \TomatoPHP\TomatoCms\Models\Post $model): RedirectResponse|JsonResponse
    {
        $request->merge([
            "author_id" => auth('web')->user()->id
        ]);
     ...
     * @return RedirectResponse|JsonResponse
     */
    public function destroy(\TomatoPHP\TomatoCms\Models\Post $model): RedirectResponse|JsonResponse
    {
